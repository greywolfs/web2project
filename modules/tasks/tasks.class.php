...
if ($AppUI->user_is_admin || $AppUI->user_is_controller){
	$filters = array('my' => 'My Tasks', 'myunfinished' => 'My Unfinished Tasks', 'allunfinished' => 'All Unfinished Tasks', 'myproj' => 'My Projects', 'mycomp' => 'All Tasks for my Company', 'unassigned' => 'All Tasks (unassigned)', 'taskowned' => 'All Tasks That I Am Owner', 'taskcreated' => 'All Tasks I Have Created', 'all' => 'All Tasks', 'allfinished7days' => 'All Tasks Finished Last 7 Days', 'myfinished7days' => 'My Tasks Finished Last 7 Days', 'delayed_tasks'=>'Delayed tasks','delayed_projects'=>'Delayed projects','current_tasks_for_the_project'=>'Current tasks for the project');
}else{
	$filters = array('my' => 'My Tasks', 'myunfinished' => 'My Unfinished Tasks', 'myproj' => 'My Projects', 'taskowned' => 'All Tasks That I Am Owner', 'taskcreated' => 'All Tasks I Have Created', 'myfinished7days' => 'My Tasks Finished Last 7 Days', 'delayed_tasks'=>'Delayed tasks','delayed_projects'=>'Delayed projects','current_tasks_for_the_project'=>'Current tasks for the project');
}
...
// end of copy()
    ...
    public function importTasks($from_project_id, $to_project_id, $project_start_date)
    {
        ...
        foreach($task_list as $orig_id => $orig_task) {
			...
			$orig_task['task_percent_complete']=0;
